...
namespace gUVLib.Model
{
    ...
    class Stone : IDataErrorInfo, INotifyPropertyChanged, ICloneable
    {
        ...
        public Stone(string ctlNum)
        {
            _controlNumber = ctlNum;
        }
        ...
        public Visibility ShowMultiColorComment
        {
            get
            {
                ...
                if (AppSettings.Instance.ShowMultiColorComment && WarningMessage != "")
            ...
            string userName, out string code, out string message, out System.Net.HttpStatusCode httpStatusCode)
        {
            ...
            try
            {
                ...
                result = GiaSpectrum.Upload(AppSettings.Instance.endpoints.upload_url, body, out code, out message, out httpStatusCode);
