    ...
    public static class Drift
    {
        ...
        static Drift()
        {
            ...
            if (LoadHemisphereMotorProfile())
            {
                ...
                _motorConnectTimer.Interval = 2000;
        ...
        static bool LoadHemisphereMotorProfile()
        {
            ...
            try
            {
                ...
                using (var reader = new StreamReader("FTIRDriftMotorProfile.txt"))
                {
            ...
            catch (Exception ex)
            {
                ...
                DeviceEvent e = new DeviceEvent("FTIR", new FTIREvent(EventType.Error, ex.Message, null));
        ...
        public static void Open(Object sender, DoWorkEventArgs e)
        {
            ...
            if (System.Threading.Monitor.TryEnter(_commandActive, 12000))
            {
                ...
                {
                    //App.LogEntry.AddEntry(ex.Message, true);
                    DeviceEvent ee = new DeviceEvent("FTIR", new FTIREvent(EventType.Error, ex.Message, null));
        ...
        static void CheckAck()
        {
            ...
            {
                throw new ApplicationException("The command was not acknowledged - please try again momentarily." + response);
            }
        }
        ...
        static void _motorConnectTimer_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            _udpClient = new UdpClient(7780);
            _udpClient.Client.ReceiveBufferSize = 50;
            DeviceEvent de = new DeviceEvent("FTIR", new FTIREvent(EventType.Info, "Trying to connect to Stepper Motor", null));
            ...
            try
            {
                ...
                if (_udpClient.Available > 0) // is there a packet ready?
                {
                    ...
                    if (returnData != "" && returnData.Substring(3, 1) == "2")
                    {
                        ...
                        WriteLine("OP");
                        System.Threading.Thread.Sleep(1000);
                        de = new DeviceEvent("FTIR", new FTIREvent(EventType.Info, "Hemisphere Option Board: " + ReadLine(), null));
                        EventBus.Instance.PostEvent(de);

                        WriteLine("SC");
                        System.Threading.Thread.Sleep(1000);
                        string response = ReadLine().Substring(3);
                        de = new DeviceEvent("FTIR", new FTIREvent(EventType.Info, "Hemisphere Status: 0x" + response, null));
                        EventBus.Instance.PostEvent(de);
                    }
                    else
                    {
                        ...
                        DeviceEvent ee = new DeviceEvent("FTIR", new FTIREvent(EventType.Error, "Hemisphere : Please power cycle the Motor Drive and try connecting again", null));
                        UtilsLib.EventBus.Instance.PostEvent(ee);
                        return;
                    }
                }
            ...
            catch (Exception ex)
            {
                ...
                de = new DeviceEvent("FTIR", new FTIREvent(EventType.Error, ex.Message, null));
                EventBus.Instance.PostEvent(de);
            }
        ...
        static void _motorConnectTimer_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            foreach (string port in ports)
            {
                try
                {
                    ...
                    catch
                    {
                        ...
                        DeviceEvent er = new DeviceEvent("FTIR", new FTIREvent(EventType.Error, "Unsupported Hemisphere Motor Drive", null));
                    ...
                    DeviceEvent ee = new DeviceEvent("FTIR", new FTIREvent(EventType.Info, "Hemisphere  Model/Revision: " + mvRead, null));
                    UtilsLib.EventBus.Instance.PostEvent(ee);
                    ...
                    ee = new DeviceEvent("FTIR", new FTIREvent(EventType.Info, "Hemisphere Option Board: " + _serialPort.ReadLine(), null));
                    UtilsLib.EventBus.Instance.PostEvent(ee);
                    ...
                    ee = new DeviceEvent("FTIR", new FTIREvent(EventType.Info, "Hemisphere Status: 0x" + response, null));
                    UtilsLib.EventBus.Instance.PostEvent(ee);
            ...
            DeviceEvent det = new DeviceEvent("FTIR", geb);
