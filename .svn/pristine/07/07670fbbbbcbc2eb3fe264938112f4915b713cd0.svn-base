    ...
    public static class SPCHelper
    {
                                        ...
                                        string xAxisLabel, string yAxisLabel, string notes = "")
        {
            ...
            catch (Exception ex)
            {
                ...
                DeviceEvent eb = new DeviceEvent("DPL", new DPLEvent(EventType.Error, "Save Failed: SPC " + ex.Message, null));
                                        ...
                                        string xAxisLabel, string yAxisLabel)
        {
            ...
            catch (Exception ex)
            {
                //App.Current.Dispatcher.Invoke(new Action(() =>
                //    System.Windows.MessageBox.Show(App.Current.MainWindow, ex.Message, "Save Failed")));
                DeviceEvent eb = new DeviceEvent("DPL", new DPLEvent(EventType.Error, "Save Failed: TXT " + ex.Message, null));
                EventBus.Instance.PostEvent(eb);
                return false;
            }
