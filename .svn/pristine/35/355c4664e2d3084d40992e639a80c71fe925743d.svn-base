...
namespace UtilsLib
{
    ...
    public class FTIREvent
    {
        public EventType eventType;
        public string message;
        public object result;

        public FTIREvent(EventType e, string m, object r)
        {
            eventType = e;
            message = m;
            result = r;
    ...
    public class DeviceManager : INotifyPropertyChanged
    {
        ...
        public DeviceManager(string name) { DeviceName = name; status = Status.DisConnected; }
        public virtual bool InitialStone( string ctlNum ) { return false; }
        public virtual bool ConnectEx() { return false; }
        public virtual bool ReconnectEx() { return false; }
